...
begin
  ...
  insert into public.payment_attachments(payment_submission_id,tenant_id,file_path,file_name,content_type)
  values(payment_id,a.tenant_id,p_path,p_file_name,p_content_type);
