...
export function RentDueActions({
  ...
  function openOnlinePaymentModal() { setOnlineOpen(true); }
  ...
  return (
    <div className="space-y-2">
      ...
      {onlineOpen ? <AdminPaymentSlipUpload billId={billId} tenantName={tenantName} propertyName={propertyName} roomName={roomName}
        rentOutstanding={outstandingAmountValue} depositOutstanding={0} outstandingLabel={outstandingAmount}
        paymentDateDefault={paidDateDefault} selectedMonth="" selectedProperty="" hideTrigger open={onlineOpen} onOpenChange={setOnlineOpen} /> : null}
